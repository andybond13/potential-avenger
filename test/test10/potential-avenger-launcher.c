...
int main(int argc, const char* argv[]) {
	...
	YcvIn.at(Nelt * 0.1) *= (1.0 - alfa);
	YcvIn.at(Nelt * 0.15) *= (1.0 - alfa);
	YcvIn.at(Nelt * 0.3) *= (1.0 - alfa);
	YcvIn.at(Nelt * 0.32) *= (1.0 - alfa);
	YcvIn.at(Nelt * 0.6) *= (1.0 - alfa);
	YcvIn.at(Nelt * 0.7) *= (1.0 - alfa);
	YcvIn.at(Nelt * 0.85) *= (1.0 - alfa);
	YcvIn.at(Nelt * 0.92) *= (1.0 - alfa);
